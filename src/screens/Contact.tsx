    ...
    <section id="contact" className="py-24 bg-dark-bg">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center gradient-text">Get In Touch</h2>
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-dark-surface to-black border border-gray-800 rounded-2xl overflow-hidden h-full">
                ...
                <div className="p-8 relative">
                  ...
                  <div className="mt-16">
                    <h3 className="text-2xl font-bold text-white mb-1">Vinit Sharma</h3>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a href="mailto:vinitsharmapc827@gmail.com" className="text-white hover:text-blue-400 transition-colors">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a href="tel:+917056101827" className="text-white hover:text-blue-400 transition-colors">
                            +91 7056101827
                          </a>
                        </div>
                      </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            placeholder='Name'
                            className={`w-full bg-dark-bg border ${formErrors.name ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                          />
                          {formErrors.name && (
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            className={`w-full bg-dark-bg border ${formErrors.email ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full bg-dark-bg border ${formErrors.subject ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleChange}
                          rows={6}
                          className={`w-full bg-dark-bg border ${formErrors.message ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none`}
